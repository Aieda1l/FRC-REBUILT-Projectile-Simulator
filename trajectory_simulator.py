...
class GamePiece(Enum):
    ...
    # 2026 game piece (hypothetical - adjust as needed)
    CORAL = "coral"
...
class GamePieceProperties:
    ...
    def from_game_piece(cls, piece: GamePiece) -> 'GamePieceProperties':
        ...
        properties = {
            GamePiece.CORAL: cls(
                name="Coral (2026)",
                mass=0.235,  # ~235g estimated
                radius=0.1016,  # ~4 inch radius
        ...
        return properties.get(piece, properties[GamePiece.CORAL])
